    ...
    <div className="w-[100%]">
      ...
      <div className="xl:container mx-auto my-0 mt-[30px] md:mt-[100px] px-[20px]">
        <div className="flex gap-[20px] md:gap-[40px] flex-col sm:flex-row items-left justify-center p-[20px] md:p-[30px] shadow-2xl rounded-2xl">
          <div className="left">
            <img className="w-[80px] sm:w-[150px]" src={process.env.PUBLIC_URL+"/resource/moneyback-gurantee.8417d885.png"} alt="" />
          </div>
          <div className="right flex flex-col justify-center items-start text-left">
            <p class="text-sm sm:text-base mb-3 font-semibold text-gray-600">
              MY 100% NO-RISK DOUBLE-GUARANTEE
            </p>
            <h2 class="mb-4 text-base sm:text-xl font-bold">
            ...
            <p class="mb-5 text-sm sm:text-base">
              Here's why I'm offering this -</p><p class="mb-5 text-sm sm:text-base">I have seen the power of automating your business workflows. Take some
                time out of your busy schedule today and see what all things can be
                automated in your workflows.
            </p>
            <p class="mb-5 text-sm sm:text-base">
              You will find that most of your time is going in doing things that could be done better by automating. You just have to give it a shot!</p><p class="mb-5 text-sm sm:text-base">Start with automating small workflow and then gradually you will love
                it!!
            </p>
            <p class="mb-5 text-sm sm:text-base">
            ...
            <img alt="sign" src={process.env.PUBLIC_URL + "/resource/paresh-signature.ffbb67b9.png"} width="210" height="63" class="h-16 mt-10 -ml-8 -mb-4" />
            <h3 class="font-semibold">Paresh Deshmukh</h3><h3 class="text-xs">Co-Founder BoloForms</h3>
          </div>
        </div>
      </div>
      <Support />
